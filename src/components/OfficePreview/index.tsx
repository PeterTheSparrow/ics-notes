...
export default function OfficePreview(props) {
    ...
    return (
        ...
        { () => {
            ...
            // 得出移动端和桌面端的链接
            const mobileOfficeUrl = "//view.officeapps.live.com/op/embed.aspx?src=" + window.location.protocol + "//" + window.location.host + props.place;
            const desktopOfficeUrl = "//view.officeapps.live.com/op/view.aspx?src=" + window.location.protocol + "//" + window.location.host + props.place;
